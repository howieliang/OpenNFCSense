...
String[] QStrings = {"77-65=", "777-654=", "7777-6543="};
String[] AStrings = {"12", "123", "1234"};
int qIndex = 0;
...
void draw() {
  ...
  if (lastString.equals("")) {
    ...
    if(bCorrect) drawString(QStrings[qIndex]+lastString, 50, 100,color(22, 160, 133));
    else drawString(QStrings[qIndex]+lastString, 50, 100,color(231, 76, 60));
  }
  /*== Put your codes above ==*/
